...
class SpotCalculator:
    ...
    def get_spot_estimations(self, os, vCPUs, memory, storage_size , region='all', type='all', behavior='terminate',
        ...
        ec2 = SpotInstanceCalculator(ec2_data).get_spot_estimations(vCPUs, memory, 'all', 'all', region, type, behavior,
    ...
    ##fleet offers
    def get_fleet_offers(self, os, region, app_size, params, pricing, Architecture, typeMajor): ## params- list of all components
        ec2_data = self.get_ec2_from_cache(region, os)
        # if os == 'linux':
        #     file = open('ec2_data_Linux.json')
        # else:
        ...
        return get_fleet_offers(params,region,os,app_size, ec2, pricing, Architecture, typeMajor)
