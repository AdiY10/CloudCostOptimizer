...
The goal of the project is to provide the user an API for the best configuration for cloud services according to their requirements. The Optimizer supports multiple cloud providers simultaneously (AWS / Azure), or can combine both (Hybrid).
